...
const IntroSVG = () => {
  return (
    <div>
         <div className="parallax" data-relative-input="true"><svg width="27" height="29" className="layer p1"
            xmlns="http://www.w3.org/2000/svg" style={{transform: 'translate(26.5467px, -5.66667px)'}}>
            <path
            ...
            fill="#FFD15C" fill-rule="evenodd"></path>
            </svg><svg width="26" height="26" className="layer p2" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(19.91px, -4.25px)'}}>
            <path d="M13 3.3541L2.42705 24.5h21.1459L13 3.3541z" stroke="#FF4C60" stroke-width="3" fill="none"
            fill-rule="evenodd"></path>
            </svg><svg width="30" height="25" className="layer p3" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(15.928px, -3.4px)'}}>
            <path
            d="M.1436 8.9282C3.00213 3.97706 8.2841.92763 14.00013.92796c5.71605.00032 10.9981 3.04992 13.85641 8 2.8583 4.95007 2.8584 11.0491-.00014 16.00024l-2.77128-1.6c2.28651-3.96036 2.28631-8.84002.00011-12.8002-2.2862-3.96017-6.5124-6.40017-11.08513-6.4-4.57271.00018-8.79872 2.43984-11.08524 6.4002l-2.77128-1.6z"
            fill="#44D7B6" fill-rule="evenodd"></path>
            </svg><svg width="15" height="23" className="layer p4" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(39.82px, -8.5px)'}}>
            <rect transform="rotate(30 9.86603 10.13397)" x="7" width="3" height="25" rx="1.5" fill="#FFD15C"
            fill-rule="evenodd"></rect>
            </svg><svg width="15" height="23" className="layer p5" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(49.775px, -10.625px)'}}>
            <rect transform="rotate(30 9.86603 10.13397)" x="7" width="3" height="25" rx="1.5" fill="#6C6CE5"
            fill-rule="evenodd"></rect>
            </svg><svg width="49" height="17" className="layer p6" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(22.1222px, -4.72222px)'}}>
            ...
            </svg><svg width="26" height="26" className="layer p7" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(18.1px, -3.86364px)'}}>
            <path d="M13 22.6459L2.42705 1.5h21.1459L13 22.6459z" stroke="#FFD15C" stroke-width="3" fill="none"
            fill-rule="evenodd"></path>
            </svg><svg width="19" height="21" className="layer p8" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(26.5467px, -5.66667px)'}}>
            <rect transform="rotate(-40 6.25252 10.12626)" x="7" width="3" height="25" rx="1.5" fill="#6C6CE5"
            fill-rule="evenodd"></rect>
            </svg><svg width="30" height="25" className="layer p9" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(39.82px, -8.5px)'}}>
            <path
            ...
            fill="#6C6CE5" fill-rule="evenodd"></path>
            </svg><svg width="47" height="29" className="layer p10" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(17.313px, -3.69565px)'}}>
            ...
            </svg><svg width="33" height="20" className="layer p11" xmlns="http://www.w3.org/2000/svg"
            style={{transform: 'translate(22.1222px, -4.72222px)'}}>
            <path
